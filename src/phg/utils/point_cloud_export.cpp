...
DataExporter::DataExporter(cv::Mat outputData, cv::Mat outputColor, std::string outputfile, FileFormat outputformat) : filename(outputfile), format(outputformat), data(outputData), colors(outputColor) {
    // MARK: Init
    // Opening filestream
    switch (format) {
